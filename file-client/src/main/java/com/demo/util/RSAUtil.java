...
public class RSAUtil {
     ...
     * @return
     */
    public static String publicDecrypt(String signature, String publicKeyStr) throws Exception {
        byte[] bytes = publicDecrypt(signature.getBytes(), string2PublicKey(publicKeyStr));
