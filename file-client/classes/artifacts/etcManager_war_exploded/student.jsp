	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12 version-detail">
				<div class="row">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" action="listUser" method="post" id="info_classify_FormId">


						<div class="col-xs-12">
							<input type="text"  name="name" maxlength="100" placeholder="名称">
					...
					<div class="col-md-6">
						<nav aria-label="Page navigation">
							<ul class="pagination">
								...
								<li><a href="${pageContext.request.contextPath}/listUser?pageNum=1">首页</a></li>

								<!--上一页-->
								<li>
									<c:if test="${pageInfo.hasPreviousPage}">
										<a href="${pageContext.request.contextPath}/listUser?pageNum=${pageInfo.pageNum-1}" aria-label="Previous">
								...
								<c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
									...
									<c:if test="${page_num != pageInfo.pageNum}">
										<li><a href="${pageContext.request.contextPath}/listUser?pageNum=${page_num}">${page_num}</a></li>
									</c:if>
								</c:forEach>
								...
								<li>
									<c:if test="${pageInfo.hasNextPage}">
										<a href="${pageContext.request.contextPath}/listUser?pageNum=${pageInfo.pageNum+1}"
										   aria-label="Next">
											<span aria-hidden="true">»</span>
										</a>
									</c:if>
								...
								<li><a href="${pageContext.request.contextPath}/listUser?pageNum=${pageInfo.pages}">尾页</a></li>
							</ul>
						</nav>
					</div>
				</div>--%>
...
<script type="text/javascript">
	jQuery(function($) {
        $("#sort").click(function(){
            $("#info_classify_FormId").attr("action","listUser?desc=true");
            $("#info_classify_FormId").submit();
        })
